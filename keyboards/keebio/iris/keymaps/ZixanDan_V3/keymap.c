...
//   ),
  ...
  [_WASD2] = LAYOUT(
     ...
     KC_LGUI, KC_LALT,  KC_Z,     KC_X,    KC_C,    KC_V,  XXXXXXX,          XXXXXXX, KC_N, KC_M,  KC_COMM, KC_PDOT, KC_BSLS, XXXXXXX,
                                    ...
                                    KC_LSFT,  KC_SPC, TAB_TALK,                  KC_LSFT, TG(_WASD2), XXXXXXX
...
TG(_NUMBERS_L),XXXXXXX,XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                            XXXXXXX,  KC_PEQL, KC_PSLS, KC_PAST, KC_PMNS, XXXXXXX,
  ...
  [_MODS] = LAYOUT(
   ...
   TO(_LOCKED),XXXXXXX,XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                           XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
     ...
     XXXXXXX, XXXXXXX, XXXXXXX, WASD2, XXXXXXX, XXXXXXX,  XXXXXXX,         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
